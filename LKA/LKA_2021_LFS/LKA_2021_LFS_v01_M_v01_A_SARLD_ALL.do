...
if ("`c(username)'"=="sunquat") {
	* load data
	* start with HH data
	use "${surveydata}/2021LFSAnnual-OutFile-With-Computer", clear
}
...
g whours = q20
note whours: For LKA_2021_LFS, we used "number of hours you usually worked at this occupation work per week" instead of "number of hours you actually worked at this occupation during the reference period".
