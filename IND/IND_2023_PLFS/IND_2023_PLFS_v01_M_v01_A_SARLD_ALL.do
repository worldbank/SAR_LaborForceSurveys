...
* SF
 if ("`c(username)'"=="wb611670") {
 	* load data and merge
 	* start with individual data
 	use "${surveydata}\personvisit1_2023-24", clear
 	drop district stratum substratum subsample _merge
 	* merge in HH data
 	merge m:1 hhid using "${surveydata}\hhvisit1_2023-24", nogen assert(match)
 }
...
g		int_year = 2023 if inlist(quarter,"Q3","Q4")
replace	int_year = 2024 if inlist(quarter,"Q1","Q2")
...
* empstat_orig_year = Original employment status (12-mon ref period)
gen empstat_orig_year = prn_status if lstatus_year == 1
...
recode industrycat10_2_year (1/3=1) (4/9=2) (10/33=3) (35/39=4) (41/43=5) (45/47 55/56=6) (49/53 58/63 79=7) (64/68 83=8) (84=9) (69/78 80/82 85/99=10) (*=.)
...
* empstat_orig = Employment status, primary job (7-day ref period)
gen empstat_orig = status_cws if lstatus == 1
...
* wmore = willingness to work for more hours (7-day ref period)
egen h_available=rsum(hours_avlble_day?) if lstatus==1
gen wmore=(h_available>=7) if lstatus==1

foreach var in sick_leave sick_leave_year maternity_leave maternity_leave_year annual_leave annual_leave_year stable_occup {
	g `var' = .
}
