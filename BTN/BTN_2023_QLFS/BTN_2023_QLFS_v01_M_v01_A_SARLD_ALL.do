...
if inlist("`c(username)'","sunquat","wb611670") {
 	* load data
 	* start with HH data
 	use "${surveydata}/QLFS_2023.dta", clear
 }
...
note: BTN QLFS 2023 raw does not have pid
...
g lstatus = .
replace lstatus = 1 if inlist(q3_1,1,2,3) // did work or business or farming last week
replace lstatus = 1 if q3_2 == 1 // absent 
