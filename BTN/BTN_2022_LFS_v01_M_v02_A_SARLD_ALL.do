...
if inlist("`c(username)'","sunquat","wb611670") {
 	* load data
 	* start with HH data
 	use "${surveydata}/LFS2022_PUF.dta", clear
 }
**FINAL FILES
...
g unitwage = 5 if lstatus==1 & ~inlist(q4_7,-98,.,.a)
...
g stable_occup = (q4_2 >=4) & ~mi(q4_2) if lstatus==1
