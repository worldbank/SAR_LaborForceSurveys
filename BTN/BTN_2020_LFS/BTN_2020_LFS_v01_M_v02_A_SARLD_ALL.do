...
* BTN LFS 2020 is conducted in Nov and Dec of 2022
g int_month = 11
...
g unitwage_2 = 5 if lstatus==1 & ~inlist(q4_10,98,.)
...
g whours_2 = q4_11 if lstatus==1

* wmore - Willingness to work for more hours
recode q4_13 (1=1) (2=0) (*=.) if lstatus==1, g(wmore)
...
foreach unavailable_var in contract_year empldur_orig_2_year empldur_orig_year empstat_2_year empstat_year firmsize_l_2_year firmsize_l_year firmsize_u_2_year firmsize_u_year ///
	...
	paid_leave pensions socialsec empstat_2 firmsize_l_2 firmsize_u_2 industry_orig_2 industrycat10_2 industrycat4_2 occup_2 occup_orig_2 ocusec_2 paid_leave_2 pensions_2 ///
 maternity_leave maternity_leave_year sick_leave sick_leave_year annual_leave annual_leave_year {
