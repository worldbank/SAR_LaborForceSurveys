...
replace int_year = . if !inrange(int_year,2016, 2017)
...
replace int_year = 2016 if missing(int_year) & inlist(qtr, 1 ,2)
replace int_year = 2017 if missing(int_year) & inlist(qtr, 3 ,4)

* hhid = Household identifier
gen qtr_str = "16-q3-" if qtr == 1
replace qtr_str = "16-q4-" if qtr == 2
replace qtr_str = "17-q1-" if qtr == 3
replace qtr_str = "17-q2-" if qtr == 4
...
egen  pid = concat(qtr_str hhid lineno_str)
