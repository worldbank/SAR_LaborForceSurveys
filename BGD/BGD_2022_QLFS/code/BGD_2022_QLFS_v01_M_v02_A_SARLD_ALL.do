...
recode educat7 (0 = 1) (1 2 3 4 = 2) (5 = 3) (6 7 8 9 = 4) (10 = 5) (11 12  = 6) (13 14 15 = 7) (16 = 0)
...
replace lstatus = 1 if EMP_03 == 1 //worked unpaid in family bussiness for sale
replace lstatus = 1 if EMP_04 == 1 //produced goods and agri for sale
replace lstatus = 1 if EMP_06 == 1 & EMP_09 == 1  //absent and received payment
replace lstatus = 1 if EMP_06 == 1 & inlist(EMP_08, 1,2) //absent and will return

replace lstatus = 2 if JSA_01 == 1 & inlist(JSA_06, 1, 2) // looking to start a new job & available to start
replace lstatus = 2 if JSA_02 == 1 & inlist(JSA_06, 1, 2) // looking to start a new business & available
replace lstatus = 2 if JSA_05A == "A" // waiting to start new job

replace lstatus = 3 if missing(lstatus) //not in LF
